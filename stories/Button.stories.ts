...
export default {
    ...
    argTypes: {
        variant: {
            control: "select",
            options: ["default", "primary", "destructive", "outline", "combobox", "secondary", "ghost", "link", "neutral", "tertiary", "icon"],
        },
        size: {
            control: "select",
            options: ["sm", "md", "lg", "xl", "fab"],
        },
        disabled: {
            control: "boolean",
        },
    ...
    render: (args: string, { slots }: { slots: Record<string, unknown> }) => ({
        components: { Button },
        setup() {
            return { args, slots }
        },
