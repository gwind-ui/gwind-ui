try {
    ;(() => {
        ...
        var E = (e => (typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (o, c) => (typeof require < "u" ? require : o)[c] }) : e))(function (e) {
        ...
        var ue = (e, o, c, r) => {
            if ((o && typeof o == "object") || typeof o == "function") for (let i of ae(o)) !se.call(e, i) && i !== c && W(e, i, { get: () => o[i], enumerable: !(r = ie(o, i)) || r.enumerable })
            return e
        }
        var de = (e, o, c) => ((c = e != null ? re(ce(e)) : {}), ue(o || !e || !e.__esModule ? W(c, "default", { value: e, enumerable: !0 }) : c, e))
        var p = D(() => {})
        var h = D(() => {})
        var f = D(() => {})
        var X = le((Q, V) => {
                                ...
                                ;((s.prototype.get = function (t) {
                                    ...
                                    (s.prototype.set = function (t, n) {
                                        ...
                                        return this.lastItem && this.isEqual(this.lastItem.key, t)
                                            ...
                                            : ((u = this.indexOf(t)), u >= 0 ? ((this.lastItem = this.list[u]), (this.list[u].val = n), this) : ((this.lastItem = { key: t, val: n }), this.list.push(this.lastItem), this.size++, this))
                                    }),
                            ...
                            function (r, i, I) {
                                    ...
                                    return function (_) {
                                        var m = function () {
                                            var b = d,
                                                ...
                                                O = !0,
                                                A
                                            if ((m.numArgs || m.numArgs === 0) && m.numArgs !== T + 1) throw new Error("Memoizerific functions should always be called with the same number of arguments")
                                            for (A = 0; A < T; A++) {
                                            ...
                                            return (
                                                ...
                                                a > 0 && ((x[T] = { cacheItem: b, arg: arguments[T] }), O ? t(l, x) : l.push(x), l.length > a && n(l.shift())),
                                                (m.wasMemoized = O),
                                                (m.numArgs = T + 1),
                                                R
                                            )
                                        }
                                        return ((m.limit = a), (m.wasMemoized = !1), (m.cache = d), (m.lru = l), m)
                                    }
                                }
                                function t(a, d) {
                                    var l = a.length,
                                ...
                                function n(a) {
                                    var d = a.length,
                                        ...
                                        _,
                                        m
                                    for (l.cacheItem.delete(l.arg), m = d - 2; m >= 0 && ((l = a[m]), (_ = l.cacheItem.get(l.arg)), !_ || !_.size); m--) l.cacheItem.delete(l.arg)
                                }
                                function u(a, d) {
                                    return a === d || (a !== a && d !== d)
                                }
            ...
            var i = r.reduce(function (t, n) {
                ...
                return u
                    ? t.concat(
                          u.map(function (a) {
                              var d, l
                              return (l = (d = a.match(/[\t ]/g)) === null || d === void 0 ? void 0 : d.length) !== null && l !== void 0 ? l : 0
                          })
                      )
                    : t
            }, [])
...
`)),
        ...
        var ne = "storybook/background",
            ...
            me = w(function () {
                ...
                return g.createElement(pe, { length: _, backgroundMap: s, item: d, updateGlobals: c, backgroundName: u, setIsTooltipVisible: I, isLocked: l, isGridActive: a, isTooltipVisible: i })
            }),
            pe = w(function (e) {
                let { item: o, length: c, updateGlobals: r, setIsTooltipVisible: i, backgroundMap: I, backgroundName: s, isLocked: t, isGridActive: n, isTooltipVisible: u } = e,
                    a = U(
                        d => {
                            r({ [S]: d })
                        },
                ...
                return g.createElement(
                    M,
                    null,
                    g.createElement(B, { key: "grid", active: n, disabled: t, title: "Apply a grid to the preview", onClick: () => a({ value: s, grid: !n }) }, g.createElement(q, null)),
                    c > 0
                        ? g.createElement(
                              H,
                              {
                              ...
                              g.createElement(B, { disabled: t, key: "background", title: "Change the background of the preview", active: !!o || u }, g.createElement(z, null))
                          )
                        : null
                )
            }),
      ...
      `)
            ...
            te = (0, Y.default)(1e3)((e, o, c, r, i, I) => ({
                id: e || o,
                title: o,
                onClick: () => {
                    i({ selected: c, name: o })
            ...
            ge = (0, Y.default)(10)((e, o, c) => {
                let r = e.map(({ name: i, value: I }) => te(null, i, I, !0, c, I === o))
            ...
            _e = w(function () {
                ...
                Array.isArray(e) && K.warn("Addon Backgrounds api has changed in Storybook 6.0. Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md")
                let t = U(
                    n => {
                        i({ [S]: { ...r[S], value: n } })
                    },
                ...
                return e.disable
                    ...
                    : g.createElement(
                          ...
                          g.createElement(B, { key: "background", title: "Change the background of the preview", active: s !== "transparent" || o }, g.createElement(z, null))
                      )
            }),
            ye = w(function () {
                let [e, o] = L(),
                ...
                let r = e[S]?.grid || !1
                return g.createElement(B, { key: "background", active: r, title: "Apply a grid to the preview", onClick: () => o({ [S]: { ...e[S], grid: !r } }) }, g.createElement(q, null))
            })
        N.register(ne, () => {
            N.add(ne, {
                title: "Backgrounds",
                ...
                render: () => (FEATURES?.backgroundsStoryGlobals ? g.createElement(me, null) : g.createElement(M, null, g.createElement(_e, null), g.createElement(ye, null))),
            })
        })
    })()
} catch (e) {
