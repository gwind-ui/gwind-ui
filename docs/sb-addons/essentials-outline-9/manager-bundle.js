    ...
    ;(() => {
        ...
        var s = "storybook/outline",
            ...
            A = d(function () {
                ...
                return (
                    m(() => {
                        i.setAddonShortcut(s, { label: "Toggle Outline", defaultShortcut: ["alt", "O"], actionName: "outline", showInMenu: !1, action: a })
                    }, [a, i]),
                    t.createElement(C, { key: "outline", active: I, title: "Apply outlines to the preview", onClick: a }, t.createElement(h, null))
                )
            })
        l.register(s, () => {
            l.add(s, { title: "Outline", type: p.TOOL, match: ({ viewMode: c, tabId: r }) => !!(c && c.match(/^(story|docs)$/)) && !r, render: () => t.createElement(A, null) })
        })
    })()
} catch (e) {
