    ...
    ;(() => {
        ...
        var s = "storybook/measure-addon",
            ...
            h = () => {
                ...
                return (
                    u(() => {
                        i.setAddonShortcut(s, { label: "Toggle Measure [M]", defaultShortcut: ["M"], actionName: "measure", showInMenu: !1, action: a })
                    }, [a, i]),
                    t.createElement(_, { key: b, active: I, title: "Enable measure", onClick: a }, t.createElement(C, null))
                )
            }
        l.register(s, () => {
            l.add(b, { type: m.TOOL, title: "Measure", match: ({ viewMode: r, tabId: c }) => r === "story" && !c, render: () => t.createElement(h, null) })
        })
    })()
} catch (e) {
