try {
    ;(() => {
        ...
        var x = (e => (typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, l) => (typeof require < "u" ? require : t)[l] }) : e))(function (e) {
        ...
        var ye = (e, t, l, s) => {
            if ((t && typeof t == "object") || typeof t == "function") for (let a of fe(t)) !be.call(e, a) && a !== l && J(e, a, { get: () => t[a], enumerable: !(s = he(t, a)) || s.enumerable })
            return e
        }
        var Se = (e, t, l) => ((l = e != null ? me(ge(e)) : {}), ye(t || !e || !e.__esModule ? J(l, "default", { value: e, enumerable: !0 }) : l, e))
        var f = U(() => {})
        var g = U(() => {})
        var b = U(() => {})
        var ce = we((ae, Z) => {
                                ...
                                ;((I.prototype.get = function (o) {
                                    ...
                                    (I.prototype.set = function (o, i) {
                                        ...
                                        return this.lastItem && this.isEqual(this.lastItem.key, o)
                                            ...
                                            : ((m = this.indexOf(o)), m >= 0 ? ((this.lastItem = this.list[m]), (this.list[m].val = i), this) : ((this.lastItem = { key: o, val: i }), this.list.push(this.lastItem), this.size++, this))
                                    }),
                                    ...
                                    (I.prototype.forEach = function (o, i) {
                                        var m
                                        for (m = 0; m < this.size; m++) o.call(i || this, this.list[m].val, this.list[m].key, this)
                                    }),
                            ...
                            function (s, a, w) {
                                    ...
                                    return function (u) {
                                        var d = function () {
                                            var h = p,
                                                ...
                                                R = !0,
                                                _
                                            if ((d.numArgs || d.numArgs === 0) && d.numArgs !== S + 1) throw new Error("Memoizerific functions should always be called with the same number of arguments")
                                            for (_ = 0; _ < S; _++) {
                                                if (((D[_] = { cacheItem: h, arg: arguments[_] }), h.has(arguments[_]))) {
                                                    h = h.get(arguments[_])
                                                    continue
                                                }
                                                ;((R = !1), (y = new I(!1)), h.set(arguments[_], y), (h = y))
                                            }
                                            return (
                                                R && (h.has(arguments[S]) ? (T = h.get(arguments[S])) : (R = !1)),
                                                R || ((T = u.apply(null, arguments)), h.set(arguments[S], T)),
                                                n > 0 && ((D[S] = { cacheItem: h, arg: arguments[S] }), R ? o(r, D) : r.push(D), r.length > n && i(r.shift())),
                                                (d.wasMemoized = R),
                                                (d.numArgs = S + 1),
                                                T
                                            )
                                ...
                                function i(n) {
                                    var p = n.length,
                                        ...
                                        u,
                                        d
                                    for (r.cacheItem.delete(r.arg), d = p - 2; d >= 0 && ((r = n[d]), (u = r.cacheItem.get(r.arg)), !u || !u.size); d--) r.cacheItem.delete(r.arg)
                                }
                                function m(n, p) {
                                    return n === p || (n !== n && p !== p)
                                }
        ...
        var $ = Se(ce()),
            ...
            Oe = { desktop: c.createElement(ne, null), mobile: c.createElement(re, null), tablet: c.createElement(le, null), other: c.createElement(M, null) },
            Le = ({ api: e }) => {
                let t = F(A),
                    [l, s, a] = G(),
                    [w, I] = z(!1),
                ...
                let y = p ? r.styles.height : r.styles.width,
                    T = p ? r.styles.width : r.styles.height
                return i ? null : c.createElement(Be, { item: r, updateGlobals: s, viewportMap: o, viewportName: n, isRotated: p, setIsTooltipVisible: I, isLocked: d, isActive: u, width: y, height: T })
            },
            Be = c.memo(function (e) {
                let { item: t, viewportMap: l, viewportName: s, isRotated: a, updateGlobals: w, setIsTooltipVisible: I, isLocked: o, isActive: i, width: m, height: n } = e,
                    p = X(r => w({ [A]: r }), [w])
            ...
            Pe = (0, $.default)(50)(e => [...De, ...Object.entries(e).map(([t, { name: l, ...s }]) => ({ ...s, id: t, title: l }))]),
            ...
            Ge = Q(function () {
                let [e, t] = G(),
                    ...
                    o = oe(),
                    [i, m] = z(!1)
                ;(a && !I.find(u => u.id === a) && console.warn(`Cannot find "defaultViewport" of "${a}" in addon-viewport configs, please check the "viewports" setting in the configuration.`),
                    O(() => {
                        pe(o, e, t, Object.keys(l))
                    }, [l, e, e.viewport, t, o]),
                    O(() => {
                        let u = s === "landscape"
                        ;((a && e.viewport !== a) || (s && e.viewportRotated !== u)) && t({ viewport: a, viewportRotated: u })
                    }, [s, a, t]))
                let n = I.find(u => u.id === e.viewport) || I.find(u => u.id === a) || I.find(u => u.default) || V,
                    p = ee(),
                ...
                return (
                    ...
                    w || Object.entries(l).length === 0
                        ...
                        : c.createElement(
                              ...
                              c.createElement(
                                  W,
                                  { placement: "top", tooltip: ({ onHide: u }) => c.createElement(q, { links: Me(I, n, t, u) }), closeOnOutsideClick: !0, onVisibleChange: m },
                                  c.createElement(
                                      Ne,
                                      {
                                          key: "viewport",
                                      ...
                                      c.createElement(j, null),
                                      r ? c.createElement(ze, null, e.viewportRotated ? `${n.title} (L)` : `${n.title} (P)`) : null
                                  )
                              ),
                              r
                                  ? c.createElement(
                                        Ue,
                                        null,
                                        c.createElement(Y, { styles: { 'iframe[data-is-storybook="true"]': { ...(r || { width: "100%", height: "100%" }) } } }),
        ...
        H.register(B, e => {
            H.add(B, { title: "viewport / media-queries", type: te.TOOL, match: ({ viewMode: t, tabId: l }) => t === "story" && !l, render: () => (FEATURES?.viewportStoryGlobals ? N(Le, { api: e }) : N(Ge, null)) })
        })
    })()
} catch (e) {
