    ...
    <div class="input-group add-amount-counter">
        <div class="add-amount-counter-box">
            <a class="add-amount-counter-box__button btn-decrement" @click="decrementValue">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" :class="{ 'text-lime-50': countValue > 0 }">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
            ...
            <div class="add-amount-counter-box__content">
                <input type="tel" id="sumGold" class="add-amount-counter-box__input" :value="countValue" @input="handleChange" minlength="1" required />
            </div>
