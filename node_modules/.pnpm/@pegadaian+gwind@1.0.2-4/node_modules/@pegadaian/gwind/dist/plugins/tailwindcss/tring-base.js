...
const scheme_1 = __importDefault(require("../../tring/scheme"));
const theme_1 = __importDefault(require("../../tring/theme"));
const tringTwBase = (0, plugin_1.default)(({ addBase }) => {
    addBase({
        'body': {
            fontFamily: scheme_1.default.FONT_FAMILY.nunito,
            fontWeight: theme_1.default.fontWeight.regular
        },
        ':root': {
            // Colors
