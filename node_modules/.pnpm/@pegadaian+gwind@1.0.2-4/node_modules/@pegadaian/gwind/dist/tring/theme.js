...
const tringTheme = {
    ...
    extend: Object.assign(Object.assign(Object.assign(Object.assign({}, scheme_1.default.METRICS), scheme_1.default.SPACE_TOKENS), scheme_1.default.TRING_SHADOWS), scheme_1.default.FONT_FAMILY),
};
exports.default = tringTheme;
